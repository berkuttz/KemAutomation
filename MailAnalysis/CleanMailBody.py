...
df = pd.read_excel(r'C:\Users\d4an\OneDrive - Kemira Oyj\Desktop\Projects\EMailAnalysis\WaterExports\RawData.xlsx', 'Sent')
...
df = df.to_excel(r'C:\Users\d4an\OneDrive - Kemira Oyj\Desktop\Projects\EMailAnalysis\WaterExports\WaterExpSent.xlsx',
                 index=False)
